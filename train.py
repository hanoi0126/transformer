...
if __name__ == "__main__":
    ...
    for i in range(epoch):
        ...
        wandb.log(
            {
                "epoch": i,
                "train_loss": train_losses_per_epoch[-1],
                "train_bleu_score": train_bleu_scores_per_epoch[-1],
                "val_loss": val_losses_per_epoch[-1],
                "val_bleu_score": val_bleu_scores_per_epoch[-1],
            }
        )
